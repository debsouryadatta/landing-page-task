    ...
    <>
      ...
      <section class="flex flex-col md:flex-row h-screen items-center">
        ...
        <div class="bg-white hidden lg:block w-full md:w-1/2 xl:w-2/3 h-screen">
          <img src="https://cerebral.com/app/static/media/female_2-mobile.b31d94c07b81a7d852c2.png" alt="" class="w-full h-full object-cover" />
        </div>
        ...
        flex items-center justify-center">
          ...
          <div class="w-full h-100">
            ...
            <p class="mt-8">Already have an
              account? <Link to="/login" class="text-blue-500 hover:text-blue-700 font-semibold">Log In</Link></p>
